CLASS zcx_47_expired_credit_card_alg DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF card_expired,
        msgid TYPE symsgid VALUE 'ZMC_ALG',
    ...
    DATA: mv_msgv1 TYPE string, "msgv1.
...
CLASS ZCX_47_EXPIRED_CREDIT_CARD_ALG IMPLEMENTATION.
